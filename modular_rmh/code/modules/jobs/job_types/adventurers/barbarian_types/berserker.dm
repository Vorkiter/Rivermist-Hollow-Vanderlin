/datum/job/advclass/combat/adventurer_barbarian/berserker
	title = "Berserker"
	tutorial = "You are a warrior feared for your brutality, dedicated to using your might for your own gain. \
	Might equals right, and you are the reminder of such a saying."
