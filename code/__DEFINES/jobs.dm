...
#define JDO_ARTISAN 21
#define JDO_ARTISAN_APPRENTICE 21.5
//OUTSIDERS
#define JDO_FOREST_WARDEN 22
#define JDO_FOREST_RANGER 22.5
#define JDO_GROVE_DRUID 23
#define JDO_SWAMP_WITCH 23.5
//ADVENTURERS
#define JDO_ADVENTURER_BARBARIAN 24
#define JDO_ADVENTURER_BARD 24.5
#define JDO_ADVENTURER_CLERIC 25
#define JDO_ADVENTURER_DRUID 25.5
#define JDO_ADVENTURER_FIGHTER 26
#define JDO_ADVENTURER_MONK 26.5
#define JDO_ADVENTURER_PALADIN 27
#define JDO_ADVENTURER_RANGER 27.5
#define JDO_ADVENTURER_ROGUE 28
#define JDO_ADVENTURER_SORCERER 28.5
#define JDO_ADVENTURER_WARLOCK 29
#define JDO_ADVENTURER_WIZARD 29.5
//VILLAINS
